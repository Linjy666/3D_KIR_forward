...
[R01, d_01, R0, R1, d_R0, d_R1, handles.x_tick, handles.y_tick, handles.z_tick, handles.x_grid, handles.y_grid, handles.z_grid, index_mat, phase_mat] =...
    kir_forward_calculate_3d_image_grid(handles.data_info.fl, dr, handles.data_info.antenna_pos, handles.image_info, ifft_number);%Kirchhoff forward
...
for i=1:frame_number
    ...
    [bp_sum, bp_sum_cf] = back_projection_3d(...
        ...
        %}
    [bp_sum, bp_sum_cf] = kirchhoff_forward_3d(R01, d_01, R0, R1, d_R0, d_R1, calibrated_range_profiles, index_mat, phase_mat);%Kirchhoff forward
